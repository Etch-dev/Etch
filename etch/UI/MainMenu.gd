...
func _on_item_pressed(id: int) -> void:
	match id:
		...
		ITEM_MANUAL: open_url.emit("https://github.com/Etch-dev/Etch/blob/main/docs/manuals/manual_v0.6.0.md")
		ITEM_BUG_TRACKER: open_url.emit("https://github.com/Etch-dev/Etch/issues")
